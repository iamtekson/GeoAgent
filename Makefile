...
SOURCES = \
	__init__.py \
	geo_agent.py geo_agent_dialog.py

PLUGINNAME = geo_agent

PY_FILES = \
	__init__.py \
	geo_agent.py geo_agent_dialog.py

UI_FILES = geo_agent_dialog_base.ui
...
QGISDIR=C:\Users\TekKshetri\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
